...
Traffic tagged with UTM parameters now gets its own Campaigns page: visitors, conversions, and sources grouped per campaign, plus a small builder to create and copy tagged URLs so the whole team tags links the same way. Details in [UTM campaigns](/docs/utm-campaigns).
