...
Kobbe can read tracker settings from your HTML **or** from the dashboard. Use whichever fits your workflow: hardcode `data-*` attributes in your layout, manage toggles in **Site settings → Installation → Tracking options**, or combine both.
...
| Tab | What it copies |
| --- | --- |
| **Minimal** | Token only. Enable features with **Tracking options** (recommended). |
