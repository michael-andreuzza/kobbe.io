...
Kobbe shows visitors, visits, views, top pages, referrers, channels, locations, devices, and opt-in UTM campaigns so you can understand where traffic comes from and what people view. The **Bots** tab on the Sources card shows automated traffic Kobbe filters out before it reaches those stats.
