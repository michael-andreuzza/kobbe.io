...
2. Go to **Settings**.
3. Find the shared dashboard section.
4. Create a share link.
5. Copy the generated URL and send it to anyone who needs read-only access.
...
Revoking or regenerating a link immediately invalidates the previous URL.
