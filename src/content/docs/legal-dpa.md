...
This Data Processing Addendum (**DPA**) is between **Michael Alexander Web Agency, trading as Kobbe** (**Company**) and the customer using the hosted Kobbe analytics service (**Customer**). Legal and data processing questions can be sent to [support@kobbe.io](mailto:support@kobbe.io).
...
- A daily-rotating pseudonymous hash used for short-lived session and visitor counting.
