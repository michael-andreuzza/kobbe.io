...
Filtered bot traffic is summarized on the dashboard itself: the **Bots** tab on the Sources card shows how much automated traffic was kept out of your stats and why. See [Bot filtering](/docs/bot-filtering).
