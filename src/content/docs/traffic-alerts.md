...
Traffic alerts are included on Starter plans and higher on the [pricing page](/#pricing). They are opt-in per site. You can disable them any time from site settings.
