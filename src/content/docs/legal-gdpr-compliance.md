...
- Analytics events and related rollups on the hosted Service are automatically deleted after a rolling retention window (the current period is published on the [pricing page](/pricing)), unless you delete them earlier through product controls.
